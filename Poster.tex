...
\addtobeamertemplate{headline}{}
{
    ...
    \begin{tikzpicture}[remember picture,overlay,line width=\arrayrulewidth] % gradient header bar
      % Logo 
      \node [anchor=north east, inner sep=0cm] at ([xshift=-30cm,yshift=-9cm]current page.north east)
      {\includegraphics[height=7.0cm]{logos/tongji-logo-blue.eps}}; 
      % Logo 1, replace with custom logo
      \node [anchor=north east, inner sep=0cm] at ([xshift=-20cm,yshift=-8.5cm]current page.north east)
      {\includegraphics[height=8.0cm]{logos/SCU-logo.pdf}}; 
      % Extra logo 2
      \node [anchor=north east, inner sep=3cm] at ([xshift=-2cm,yshift=-6.5cm]current page.north east)
...
\Cref{fig:eval} shows the evaluation results.
\end{block}
